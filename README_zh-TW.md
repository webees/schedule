...
- [亮點](#-亮點) · [架構](#-架構) · [原子鎖](#-原子鎖) · [自癒](#-自癒) · [容錯](#-容錯)
- [檔案](#-檔案) · [核心函數](#-核心函數) · [擴展](#-擴展) · [測試](#-測試) · [啟動](#-啟動)
...
| `dispatch(round_num, time_str, ...)` | 競鎖 + 觸發 + 日誌 |
| `trigger(repo, wf)` | 使用 PAT 跨倉庫觸發 workflow |
| `is_expired(lock_tag, now_epoch, now_minute)` | 鎖過期判斷 (cron/秒級/舊格式兼容) |
